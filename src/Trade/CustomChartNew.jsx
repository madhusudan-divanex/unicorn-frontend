...
export default function CustomChart({ convertAmount, loading, data, pair, bidMarkers = [], TIMEFRAME_SEC = 60, chartType = "candle", userSetting, onLoadMore }) {
    ...
    useEffect(() => {
        ...
        const draw = () => {
            ...
            // Grid — candles ke saath move karta hai (stepW + pan offset se sync)
            // NOTE: stepW aur panPixelOffset/slideW neeche calculate hote hain,
            // isliye grid drawing ko candles ke baad move kiya — dekho "GRID_DRAW" comment neeche
