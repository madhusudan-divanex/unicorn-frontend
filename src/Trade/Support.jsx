                      ...
                      <div className="  setting-tab-details">
                        <Tab.Content>
                              ...
                              <Col md={12} className="pb-lg-0 pb-5">
                                {userRequest?.length === 0 ? <div className="d-flex justify-content-center align-items-center flex-column supprt-requt-bx ">
                                  ...
                                  <table className="w-100">
                                    <thead>
                                      <tr>
                                        <th><p className="text-white"> {t('id')} </p></th>
                                        <th><p className="text-white">{t('issue')} </p></th>
                                        <th><p className="text-white">{t('photo')} </p></th>
                                        <th><p className="text-white">{t('status')} </p></th>
                                      </tr>
                                    </thead>
                                    <tbody>
                                      {userRequest?.map((item, key) => (
                                        <tr key={key}>
                                          <td><p className="text-white">{key + 1}</p></td>
                                          <td><p className="text-white">{item?.issue}</p></td>
                                          <td><img src={`${base_url}/${item?.attachment}`} alt="" srcset="" width={'80px'} /></td>
                                          <td><p className="text-capitalize text-white">{item?.status}</p></td>
                                        </tr>
                                      ))}
                                    </tbody>
                                  </table>
                          ...
                          <Tab.Pane eventKey="create" active={key === "create"}>
                            <Row className="support-tab-section pb-lg-0 pb-5">
                              <Col md={6}>
                              ...
                              <Col md={6} className="d-flex flex-column justify-content-center align-items-center">
                                <div>
                                  ...
                                  <div className="requst-subject mt-5">
                                    <h5 className="select-title">{t('selectSubject')}</h5>
                                  </div>
                                  <div className="requst-btm-bx">
                                    <div className="d-flex flex-column align-items-center p-lg-4 p-sm-12">
                                      {/* Tabs */}
                                      <div className="d-flex gap-2 mb-3 flex-column flex-lg-row">
                                  ...
                                  <div className="requst-subject w-100">
                                    <div className=" p-lg-4 p-sm-0">
                                      <div className="issue-box">
                                        ...
                                        {/* Confirm Button */}
                                        <button type="button" className="tour-join-details-btn  w-100" onClick={sendReport}>
                                          {t('confirmAndSend')}
                                        </button>
                                      </div>
                                    </div>
                          ...
                          <Tab.Pane eventKey="faq" active={key === "faq"}>
                            ...
                            <Row>
                              ...
                              <Col lg={12} md={12} sm={12} className="">
                                <div className="tab-faq-section ">
                                  ...
                                  <div className="faq-main-crd-bx">
                                    {faqData?.length > 0 &&
                                      faqData?.map((item, key) => (
                                        <div className={item?.type == activeType ? "faq-bx-crd faq-bx-crd-active" : "faq-bx-crd faq-bx-crd"} key={key} onClick={() => {
                            ...
                            <Row className="mt-3 pb-lg-0 pb-5">
                              {/* Left Column */}
                              <Col lg={6} md={6} sm={12}>
                                <div className="tour-faq-bx">
                                  <Accordion flush>
